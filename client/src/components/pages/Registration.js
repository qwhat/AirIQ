...
export default class Registration extends Component {
	...
	uniqueEmail = (email) => {
		return axios.post('http://localhost:3001/checkEmail', { email: email }).then((result) => {
			...
			return (
				<Container>
						...
						<Form.Row>
							<Form.Group as={Col} md="4" controlId="validationCustom03">
								...
								>
									...
									<option value="medical_concern">
										Medical Concern: Asthma, Immune deficiencies, Respitory or Heart Conditions,
										seniors or children.
									</option>
									<option value="lifestyle">
										Lifestyle/Sports Concern: work or athletic training with extended exposure to
										potential toxins.
									</option>
								</Form.Control>
							</Form.Group>
							...
							<Form.Group as={Col} md="4" controlId="validationCustom05">
								...
								{phone_number.validation ? (
									<div key={`inline-checkbox`} className="mb-1">
										<Form.Check
											inline
											label="Receive sms on Excellent AirQuality days"
											name="good_days"
											type="checkbox"
										...
										<Form.Check
											inline
											label="Receive sms on Poorest AirQuality days"
											name="bad_days"
											type="checkbox"
					...
					<Form.Text className="text-muted">
						*By selecting a tier we are better able to customize the air quality recommendations we send to
						you. We'll never share your personal details, email or phone number with 3rd parties.
					</Form.Text>
				</Container>
			);
		}
